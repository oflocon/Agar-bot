...
// - learns from experience :)
    ...
    var DQNAgent = function(env, opt) {
        ...
        this.activation_function = getopt(opt, 'activation_function', 1); // 1: tanh, 2: sigmoid, other: relu
    ...
    DQNAgent.prototype = {
        reset: function() {
            this.nh = this.num_hidden_units; // number of hidden unit
            //this.nh2 = 3;
            //this.nh3 = 2;
            this.ns = this.env.getNumStates();
            this.na = this.env.getMaxNumActions();
            ...
            //this.net.W3 = new R.RandMat(this.nh3, this.nh2, 0, 0.01);
            //this.net.b3 = new R.Mat(this.nh3, 1, 0, 0.01);
        ...
        forwardQ: function(net, s, needs_backprop) {
            ...
            if ( this.activation_function == 1){
                var h1mat = G.tanh(a1mat);
            }else if ( this.activation_function == 2){
            ...
            //}else{
            //    var h2mat = G.relu(a2mat);
            //}
            //
            //var a3mat = G.add(G.mul(net.W3, h2mat), net.b3);
            //if ( this.activation_function == 1){
            //    var h3mat = G.tanh(a3mat);
            //}else if ( this.activation_function == 2){
            //    var h3mat = G.sigmoid(a3mat);
            //}else{
            //    var h3mat = G.relu(a3mat);
            //}
            var a4mat = G.add(G.mul(net.W2, h1mat), net.b2);
